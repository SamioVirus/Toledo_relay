...
Run the affected checks and report exact evidence. Return a complete correction report, not a promise. Choose `continue` when the correction is ready for re-verification. Choose `human` only when a blocking decision or unavailable authority remains.
